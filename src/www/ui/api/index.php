...
spl_autoload_register(function($class) {
  if(strstr($class, __NAMESPACE__) !== FALSE) {
    $classRequired = __DIR__ . "/" . str_replace(__NAMESPACE__ . "\\", "", $class) . ".php";
    $classRequired = str_replace("\\", "/", $classRequired);
    require_once $classRequired;
  }
  if(strstr($class, "Fossology\Reuser\ReuserAgentPlugin") !== FALSE) {
    require_once dirname(dirname(dirname(__DIR__))) . "/reuser/ui/agent-reuser.php";
  }
});
